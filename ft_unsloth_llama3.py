...
def init():
    ...
    args_parser.add_argument("--dataset_name",
                             default="2sat_50mixVars_50fixCls_0.3_true_4-hop_10K_500_OR",
                             type=str)
    args_parser.add_argument("--dataset_dir", default="dataset/Entailments/50_vars_50_cls", type=str)
...
if __name__ == '__main__':
    ...
    with open(f_preds, 'a') as file_output:
        file_output.write("id;num_clauses;label;pred;is_consistent;k_hop\n")
        ...
        for index, row in df_test.iterrows():
            ...
            str_output = str(row['idx']) + ";" + str(row['num_clauses']) + ";" + id_to_label[row['label']] \
                         + ";" + str(result) + ";" + str(row['is_consistent']) + ";" + str(row['k_hop']) + "\n"
